		...
		<div className="space-y-4">
			...
			>
				<div>
					...
					<p className="text-sm text-muted-foreground">Manage your product catalog and details</p>
				</div>
				<div className="flex gap-2">
					<Button onClick={() => setShowForm(true)} variant="default">New Product</Button>
					<Button onClick={() => setShowImport(true)} variant="outline">Import CSV</Button>
